...
export default function Instructor() {
  ...
  return (
    <RootStyle title="Registration Instructor">
      ...
      <MHidden width="mdDown">
        <SectionStyle sx={{ background: '#8254e3' }}>
          ...
          >
            Jadilah Instructor di Online Course Maiden
          </Typography>
          <img
            alt="register"
            src="/static/images/illustration/illustration_instructor.png"
          />
        </SectionStyle>
      </MHidden>
          ...
          <Card sx={{ p: 4.8, backgroundColor: '#ffffff' }}>
            <Box sx={{ mb: 5 }}>
              ...
              <Typography sx={{ color: '#5A47AB' }}>
                Pengalaman mengajar sebagai bagian dari komunitas kami.
              </Typography>
            </Box>
